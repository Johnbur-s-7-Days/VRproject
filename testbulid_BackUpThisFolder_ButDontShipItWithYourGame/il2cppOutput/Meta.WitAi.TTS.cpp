...
IL_00c8:
	...
	}
	{
		...
		L_46 = CoroutineUtility_StartCoroutine_mC6A524CF8F8F56300569C6B76539FD99F4A4D8DA(L_45, (bool)0, NULL);
		// return clipData;
...
IL_010f:
	{
		...
		L_61 = CoroutineUtility_StartCoroutine_mC6A524CF8F8F56300569C6B76539FD99F4A4D8DA(L_60, (bool)0, NULL);
		// return clipData;
...
IL_0031:
	{
		...
		VLog_E_m063A8F2A17CA4676719A7D14D1AB8BD0663E9137(L_10, NULL);
...
IL_007a:
	{
		...
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_29, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TTSSpeaker_Speak_mD6A1DEBAC71CAC4CEAB5EB5210AAD1DFDEDF7F58 (TTSSpeaker_tD5B4F9BF6B84E7144D7DBD08DF599AD60A4CCA9C* __this, String_t* ___textToSpeak0, TTSDiskCacheSettings_tB9D20D402A7386227ADC2A29BA87AE6F1774EE80* ___diskCacheSettings1, bool ___addToQueue2, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		String_t* L_5;
		L_5 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(L_4, _stringLiteral2386E77CF610F786B06A91AF2C1B3FD2282D2745, NULL);
...
IL_0036:
	...
	}
	{
		...
		String_t* L_11;
		L_11 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral2386E77CF610F786B06A91AF2C1B3FD2282D2745, L_10, NULL);
...
IL_006c:
	{
		...
		String_t* L_15;
		L_15 = String_Concat_m9B13B47FCB3DF61144D9647DDA05F527377251B0(L_12, L_13, L_14, NULL);
	...
	}
	{
		...
		String_t* L_19;
		L_19 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteralD20D043DC2BB8C021CE9DD012EEBAC9EA3464160, L_18, NULL);
		VLog_E_m063A8F2A17CA4676719A7D14D1AB8BD0663E9137(L_19, NULL);
		// return;
		return;
	}
...
IL_005a:
	{
		...
		String_t* L_20;
		L_20 = String_Format_m76BF8F3A6AD789E38B708848A2688D400AAC250A(G_B8_1, G_B8_0, L_18, L_19, NULL);
...
IL_00bb:
	{
		...
		String_t* L_38;
		L_38 = String_Format_m9499958F4B0BB6089C75760AB647AB3CA4D55806(G_B21_1, G_B21_0, L_37, NULL);
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_38, NULL);
...
IL_000f:
	{
		...
		String_t* L_5;
		L_5 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral2521E50FE503883D464CA60EBBE09AA3F307F2BD, L_4, NULL);
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_5, NULL);
...
IL_005e:
	{
		...
		String_t* L_21;
		L_21 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral78A3395B74C45CDB5B2B77A5CBEBA8301D73B1A8, L_20, NULL);
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_21, NULL);
...
IL_004a:
	...
	}
	{
		...
		String_t* L_10;
		L_10 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral9D72B87414DB3B0E6D3B66CB0607BD48125F014C, L_9, NULL);
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_10, NULL);
...
IL_0105:
	{
		String_t* L_37;
		L_37 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(G_B30_1, G_B30_0, NULL);
		VLog_D_m98CADFAD363A33C07CAB1B3C3B1483202354409C(L_37, NULL);
...
IL_0056:
	{
		...
		String_t* L_15 = ___error1;
		bool L_16;
		L_16 = String_Equals_m80124ECC809968E69F952E2A49EBC03F81A23E43(L_15, _stringLiteralAC511DE6494CB691166B2E9F28AC49D3C56037BA, 1, NULL);
		if (!L_16)
		{
			goto IL_008a;
		}
